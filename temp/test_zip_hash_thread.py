...
def test_zip_and_hash_file_thread(file_path, zip_path, password):
    print("Starting test zip and hash file thread...")
    ...
    print("Finished test zip and hash file thread.")
...
def test2(file_path, zip_path, password):
    ...
    test_zip_and_hash_file_thread(file_path, zip_path, password)
    async_end = time.time()
